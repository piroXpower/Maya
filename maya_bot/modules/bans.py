...
from maya_bot import BOT_ID, WHITELISTED, tbot, decorator, mongodb, bot
from maya_bot.modules.helper_func.own_errors import NotEnoughRights
from maya_bot.modules.connections import connection
from maya_bot.modules.language import get_string, get_strings_dec
from maya_bot.modules.users import (is_user_admin, user_admin_dec,
