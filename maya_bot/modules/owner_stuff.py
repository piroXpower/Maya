...
from maya_bot import OWNER_ID, OPERATORS, MAYA_VERSION
from maya_bot.decorator import REGISTRED_COMMANDS, COMMANDS_ALIASES, register
from maya_bot.modules import LOADED_MODULES
from maya_bot.services.mongo import db, mongodb
from maya_bot.services.quart import quart
from maya_bot.services.redis import redis
from maya_bot.services.telethon import tbot
...
async def stats(message):
    text = f"<b>Maya {MAYA_VERSION} stats</b>\n"
