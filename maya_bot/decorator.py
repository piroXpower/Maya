...
from maya_bot import BOT_USERNAME, dp
from maya_bot.config import get_bool_key
from maya_bot.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("maya_bot.utils.filters." + module_name)
