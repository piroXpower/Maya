...
from maya_bot import dp
from maya_bot.config import get_bool_key, get_list_key, get_int_key
from maya_bot.modules import ALL_MODULES, LOADED_MODULES
...
# Import misc stuff
import_module("maya_bot.utils.exit_gracefully")
if not get_bool_key('DEBUG_MODE'):
    import_module("maya_bot.utils.sentry")
...
import_module("maya_bot.utils.db_structure_migrator")
